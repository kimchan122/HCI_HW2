...
WebUI.initWidgets = function() {
    ...
    WebUI.app = new WebUI.Row({
        children: [
            new WebUI.Container({
                desired_size: {width: 330, height: 60},
            ...
            new WebUI.Column({
                desired_size: {width: 330, height: 50},
                children: [
                    new WebUI.Container({
            ...
            new WebUI.Column({
                desired_size: {width: 330, height: 80},
                children: [
                    new WebUI.Container({
                    ...
                    new WebUI.Container({
                        desired_size: {width: 100, height: 80},
                        horizontal_alignment: WebUI.Alignment.LEFT,
                        vertical_alignment: WebUI.Alignment.CENTER,
            ...
            new WebUI.Column({
                desired_size: {width: 250, height: 50},
                children: [
...
WebUI.Switch.prototype.handleMouseDown = function() {
    ...
    if(!this.is_on){
        ...
        this.visual_items[3].animate('left',this.position.left+this.desired_size.width/4*1.9,{
            duration:100,
