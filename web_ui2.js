...
WebUI.initWidgets = function() {
    ...
    WebUI.app = new WebUI.Row({
        children: [
            new WebUI.Container({
                desired_size: {width: 530, height: 60},
                horizontal_alignment: WebUI.Alignment.CENTER,
                vertical_alignment: WebUI.Alignment.CENTER,
                font_size: 10,
                children: [
                    new WebUI.Text("WEBUI Calculator")],
            }),
            new WebUI.Container({
                desired_size: {width: 530, height: 40},
                horizontal_alignment: WebUI.Alignment.CENTER,
                vertical_alignment: WebUI.Alignment.CENTER,
                children: [
            ...
            new WebUI.Column({
                desired_size: {width: 530, height: 50},
                children: [
                    new WebUI.CalcButton("1",{width:40,height:40}),
                    new WebUI.CalcButton("2",{width:40,height:40}),
                    new WebUI.CalcButton("3",{width:40,height:40}),
                    new WebUI.CalcButton("4",{width:40,height:40}),
                    new WebUI.CalcButton("5",{width:40,height:40}),
                    new WebUI.CalcButton("6",{width:40,height:40}),
                    new WebUI.CalcButton("7",{width:40,height:40}),
                    new WebUI.CalcButton("8",{width:40,height:40}),
                    new WebUI.CalcButton("9",{width:40,height:40}),
                    new WebUI.CalcButton("0",{width:40,height:40}),
                ]
            }),
            new WebUI.Column({
                desired_size: {width: 530, height: 50},
                children: [
                    new WebUI.CalcButton("+",{width:40,height:40}),
                    new WebUI.CalcButton("-",{width:40,height:40}),
                    new WebUI.CalcButton("*",{width:40,height:40}),
                    new WebUI.CalcButton("/",{width:40,height:40}),
                    new WebUI.CalcButton("%",{width:40,height:40}),
            ...
            new WebUI.Column({
                desired_size: {width: 530, height: 50},
                children: [
                    new WebUI.CalcButton("i",{width:40,height:40}),
                    new WebUI.CalcButton("e",{width:40,height:40}),
                    new WebUI.CalcButton("pi",{width:40,height:40}),
                    new WebUI.CalcButton("w",{width:40,height:40}),
                    new WebUI.CalcButton("x",{width:40,height:40}),
                    new WebUI.CalcButton("y",{width:40,height:40}),
                    new WebUI.CalcButton("z",{width:40,height:40}),
                    new WebUI.CalcButton("f",{width:40,height:40}),
                    new WebUI.CalcButton("g",{width:40,height:40}),
                    new WebUI.CalcButton("=",{width:40,height:40}),
                ]
            }),
            new WebUI.Column({
                desired_size: {width: 530, height: 50},
                children: [
                    new WebUI.CalcButton("exp",{width:40,height:40}),
                    new WebUI.CalcButton("log",{width:40,height:40}),
                    new WebUI.CalcButton("sqrt",{width:40,height:40}),
                    new WebUI.CalcButton("sin",{width:40,height:40}),
                    new WebUI.CalcButton("cos",{width:40,height:40}),
                    new WebUI.CalcButton("tan",{width:40,height:40}),
                    new WebUI.CalcButton("cross",{width:40,height:40}),
                    new WebUI.CalcButton("det",{width:40,height:40}),
                    new WebUI.CalcButton("CL",{width:40,height:40}),
                    new WebUI.CalcButton("EV",{width:40,height:40}),
                ]
            }),
        ]
    });
...
//added
//WebUI.Widget.prototype.handleButtonPushed = function() {
    //return false;
//}
